export const ORDER_STATUS_LABELS: Record<string, string> = {
  ...
  SEARCH_SELECTION: "Separação",
  PRODUCT_FOUND: "Produto Localizado",
  PREPARING_INTERNATIONAL: "Preparação para Envio",
  INTERNATIONAL_TRANSIT: "Em Trânsito até o Hub",
  ARRIVED_BRAZIL: "Recebido no Hub Bravenza",
  PRODUCT_INSPECTED: "Autenticação Concluída",
  BALANCE_PENDING: "Aguardando Pagamento do Saldo",
  FULLY_PAID: "Produto Pago Integralmente",
  SHIPPED_TO_CLIENT: "Em Trânsito",
  DELIVERED: "Produto Entregue",
  LOST: "Pedido Perdido",
  // Legacy statuses (for backward compatibility with existing orders)
  ORDER_CONFIRMED: "Pedido Confirmado",
  SOURCING: "Em Separação",
  ...
  INTERNATIONAL_DISPATCH: "Em Preparação",
...
export const ORDER_STATUS_DESCRIPTIONS: Record<string, string> = {
  ...
  SEARCH_SELECTION: "Estamos localizando e separando o produto junto aos nossos parceiros.",
  PRODUCT_FOUND: "Produto localizado e selecionado!",
  PREPARING_INTERNATIONAL: "Preparando o produto para envio ao Hub Bravenza.",
  INTERNATIONAL_TRANSIT: "Seu produto está a caminho do Hub Bravenza.",
  ARRIVED_BRAZIL: "Seu produto foi recebido no Hub Bravenza!",
  PRODUCT_INSPECTED: "Produto inspecionado e autenticidade confirmada.",
  ...
  SOURCING: "Estamos localizando o melhor produto para você.",
  NEGOTIATING: "Negociando as melhores condições com nossos parceiros.",
  PURCHASE_COMPLETED: "Compra realizada com sucesso!",
  PACKAGE_EN_ROUTE: "Seu produto está a caminho do Hub Bravenza.",
  ARRIVED: "Seu produto foi recebido no Hub Bravenza!",
  INSPECTION_APPROVED: "Produto inspecionado e autenticidade confirmada.",
  BALANCE_DUE: "Aguardando pagamento do saldo restante.",
  INTERNATIONAL_DISPATCH: "Preparando envio ao Hub.",
  CUSTOMS: "Seu produto está sendo processado.",
  NATIONAL_TRANSIT: "Em trânsito para entrega.",
  DISPATCHED: "Produto saiu para entrega.",
};
