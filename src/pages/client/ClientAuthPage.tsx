...
import { Eye, EyeOff, Loader2, Mail, Lock, User, Phone, CreditCard, ArrowLeft } from "lucide-react";
import { z } from "zod";
        ...
        >
          <Card className="card-premium">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Acesse seus pedidos e o Vault Club em um só lugar
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            Ao criar uma conta, você terá acesso aos seus pedidos e ao exclusivo Vault Club.
          </p>
        </motion.div>
      </main>
    </div>
