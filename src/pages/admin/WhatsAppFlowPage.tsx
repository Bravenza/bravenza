    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Gerencie os templates de mensagens automáticas via WhatsApp (Twilio).
        </p>
      </div>

      {/* Info Card about Twilio */}
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground">
                As mensagens são enviadas via Twilio WhatsApp API. Configure suas credenciais em{" "}
                <a href="/admin/configuracoes" className="text-primary hover:underline">
              ...
              <p className="text-xs text-muted-foreground mt-2">
                ...
                para mensagens pré-aprovadas pelo WhatsApp.
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Jornada do Cliente via WhatsApp</CardTitle>
          <CardDescription>
            Cada evento importante pode disparar uma mensagem automática via WhatsApp
          </CardDescription>
        </CardHeader>
        <CardContent>
