...
const BrandsCarouselComponent = () => {
  ...
  return <section className="py-10 md:py-14 overflow-hidden bg-card/30">
      ...
      <div className="relative">
        ...
        x: {
          ...
          {duplicatedBrands.map((brand, index) => <div key={`${brand.name}-${index}`} className="flex-shrink-0 group">
