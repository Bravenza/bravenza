...
const HowItWorksSectionComponent = () => {
  ...
  const steps = [
    ...
    { icon: FileCheck, title: t("howItWorks.step2Title"), description: t("howItWorks.step2Desc") },
    { icon: CreditCard, title: t("howItWorks.step3Title"), description: t("howItWorks.step3Desc") },
    { icon: Package, title: t("howItWorks.step4Title"), description: t("howItWorks.step4Desc") },
    { icon: Truck, title: t("howItWorks.step5Title"), description: t("howItWorks.step5Desc") },
  ];
