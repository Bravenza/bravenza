...
const testimonials = [{
  ...
  rating: 5,
  text: "Atendimento absurdo de bom. Me mandaram foto do sneaker na inspeção, certificado de autenticidade, rastreio até em casa. Nunca vi algo assim. Estou no terceiro pedido já.",
