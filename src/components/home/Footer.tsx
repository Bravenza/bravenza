...
const FooterComponent = forwardRef<HTMLElement>((_, ref) => {
  ...
  return <footer ref={ref} className="border-t border-border bg-card/50">
      <div className="container mx-auto px-4 sm:px-6 py-8 md:py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <Link to="/admin/login" className="text-muted-foreground/70 hover:text-muted-foreground transition-colors text-xs">
                  Admin
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <a href="https://wa.me/5551983018897?text=Olá!%20Gostaria%20de%20saber%20mais%20sobre%20a%20BRAVENZA." target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-primary transition-colors cursor-pointer">51 98105.5425<MessageCircle className="h-3.5 w-3.5 text-primary flex-shrink-0" />
                  <span>+55 51 98301-8897</span>
                </a>
              </li>
              <li>
                <a href="https://www.instagram.com/bravenza.vault" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-primary transition-colors cursor-pointer">
        ...
        <div className="border-t border-border mt-6 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-5 text-sm text-muted-foreground">
            <Link to="/politicas" className="hover:text-primary transition-colors text-xs">
              Políticas
            </Link>
            <Link to="/termos" className="hover:text-primary transition-colors text-xs">
              Termos de Uso
            </Link>
          </div>
        </div>
