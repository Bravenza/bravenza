      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 md:py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <a href="https://wa.me/5551981055425?text=Olá!%20Gostaria%20de%20saber%20mais%20sobre%20a%20BRAVENZA." target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-primary transition-colors cursor-pointer">
                  <MessageCircle className="h-3.5 w-3.5 text-primary flex-shrink-0" />
                  <span>51 98105.5425</span>
                </a>
              </li>
              <li>
